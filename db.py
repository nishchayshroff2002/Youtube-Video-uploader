...
def insert_video(title,description,tags,category_id,privacy_status,video_extension,thumbnail_extension,user_id,owner_id):
    entry ={
        "title":title,
...
def delete_pending_video(owner_id,video_id):
    query={"owner_id": owner_id,"video_id":video_id, "is_approved":False}
